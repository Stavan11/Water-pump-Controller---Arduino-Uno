...
{
    if (digitalRead(l1)==LOW && digitalRead(l2)==LOW && digitalRead(l3)==LOW)
  level=0;
  else if (digitalRead(l1)==HIGH && digitalRead(l2)==LOW && digitalRead(l3)==LOW)
  level=33;
  else if (digitalRead(l1)==HIGH && digitalRead(l2)==HIGH && digitalRead(l3)==LOW)
  level=66; 
  else if (digitalRead(l1)==HIGH && digitalRead(l2)==HIGH && digitalRead(l3)==HIGH)
  level=99;
  else level=101;
  }
